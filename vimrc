...
set backspace=eol,start,indent "just means backspace works like it does in most other programs
set whichwrap+=<,>,h,l   "moving left and right will move to the previous line
...
"This means if a large file is being editted then everything
...
" => Text, tab and indent related
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
set noexpandtab		"tabs aren't automatically converted into spaces
set shiftwidth=4	"number of spaces to use for each level of autoindent
